 ...
 * 1. Provides a new API to get details of in-app normalTiles published for the app including
 ...
 *    in-app normalTiles are consumable and thereafter can be purchased again.
...
interface IInAppBillingService {
     ...
     * This will return all SKUs that have been purchased in V3 and managed normalTiles purchased using
     * V1 and V2 that have not been consumed.
     * @param apiVersion billing API version that the app is using
     * @param packageName package name of the calling app
     * @param type of the in-app normalTiles being requested ("inapp" for one-time purchases
     *        and "subs" for subscriptions)
