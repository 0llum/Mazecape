...
public class NormalTilesAdapter extends BaseAdapter {
    private Context context;

    public NormalTilesAdapter(Context context, int center) {
        this.context = context;
    }

    @Override
    public int getCount() {
        return GameFragment.normalTiles.size();
    }

    @Override
    public Integer getItem(int i) {
        return GameFragment.normalTiles.get(i);
    }
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        holder.imageView.setImageDrawable(ResourcesCompat.getDrawable(context.getResources(), GameFragment.normalTiles.get(position), null));
